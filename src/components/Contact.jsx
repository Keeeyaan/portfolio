  ...
  return (
    <div className="xl:mt-12 xl:flex-row flex-col-reverse flex gap-10 overflow-hidden">
      <motion.div
        ...
        className="flex-[0.75] bg-[#f3eefd] dark:bg-black-100 p-8 rounded-2xl"
      >
        ...
        >
          ...
          <button
            type="submit"
            className="bg-lighttertiary dark:bg-tertiary py-3 px-8 outline-none w-fit text-slate-900 dark:text-white font-bold shadow-md dark:shadow-primary rounded-xl"
          >
