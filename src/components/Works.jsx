  ...
  return (
    <motion.div variants={fadeIn("up", "spring", index * 0.5, 0.75)}>
      <Tilt
        ...
        className="bg-lighttertiary dark:bg-tertiary p-5 rounded-2xl sm:w-[360px] w-full"
      >
        ...
        <div className="mt-5">
          ...
          <p className="mt-2 text-lightsecondary dark:text-secondary text-[14px]">
            {description}
          </p>
        </div>
  ...
  return (
    <>
      ...
      <div className="w-full flex">
        ...
        >
          Following projects showcases my skills that I learned so far. Each
